  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-xs text-zinc-600 dark:text-zinc-400 md:text-sm">
        <span>If you like my content, please subscribe to support me 🫶</span>
        <br />
        {subCount && (
          <span>
            Join other <span className="font-medium">{subCount}</span> subscribers,
          </span>
        )}
        <span>One email per month, you can unsubscribe at any time.</span>
      </p>
      <AnimatePresence mode="wait">
        {!isSubscribed ? (
          ...
          <motion.p
            ...
            exit="initial"
          >
            Please check your email for subscription confirmation 🥳
          </motion.p>
        )}
      </AnimatePresence>
